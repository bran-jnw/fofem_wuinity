...
/* Emissions are in Pounds Per Acre                                          */
   ...
   float f_PM10S_Duff;        /* Smoldering Duff Only                      */
   float f_PM25S_Duff;        /* NOTE - the above Smoldering include Duff */
   float f_CH4S_Duff;         
   float f_COS_Duff;
   float f_CO2S_Duff;
   float f_NOXS_Duff;
...
/* Emission Factors That Burnup used */ 
...
/*  modeling function                                                        */
// Remove this old stuff used for soil heating 
...
/* Soil Heating fire intensity kW/m2, coming from Burnup  */
/* approx May 2015, for new way of doing soil heating  */
#define eC_sfi  6000
float fr_SFI[eC_sfi + 1];       /* Wood Liter */
float fr_SFIhs[eC_sfi + 1];     /* Herb Shrub */
